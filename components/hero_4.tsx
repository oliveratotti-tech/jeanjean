      ...
      <div className="relative mx-auto max-w-7xl px-6 pt-24 pb-16 lg:px-8 lg:pt-32 w-full">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            ...
            <div className="flex justify-center lg:justify-start overflow-hidden" style={{ height: "160px" }}>
              <Image
                ...
                width={800}
                height={300}
                className="w-auto max-w-full object-contain" style={{ marginTop: "-80px", height: "320px" }}
                priority
              />
            </div>
